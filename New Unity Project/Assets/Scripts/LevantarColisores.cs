...
//Baseado no vPlatform
public class LevantarColisores : MonoBehaviour
{
    #region Variables
    ...
    [HideInInspector] //Definido através do DetectarColisao
    ...
    public void Inverter(bool inverter)
    {
        movimentar = inverter;
    }
