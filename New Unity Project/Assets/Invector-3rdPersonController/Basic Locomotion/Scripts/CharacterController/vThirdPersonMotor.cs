    ...
    public class vThirdPersonMotor : vCharacter
    {
        ...
        internal bool canRollAgain
        {
            get
            {
                ...
                return isRolling && animator.GetNormalizedTime(baseLayer) > timeToRollAgain;
            }
        }
        ...
        protected virtual void RollBehavior()
        {
            ...
            // reset movement if the player release the input, so it doesn't move forward a few steps after the roll
